...
# python train.py --embed_size=16 --hidden_size=8 --num_layers=1
# python train.py --embed_size=16 --hidden_size=16 --num_layers=1
# python train.py --embed_size=16 --hidden_size=32 --num_layers=1
